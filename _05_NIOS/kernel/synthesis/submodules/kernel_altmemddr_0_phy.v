...
// ============================================================
// Megafunction Name(s):
// 			kernel_altmemddr_0_phy_alt_mem_phy
// ============================================================
...
module kernel_altmemddr_0_phy (
	...
	kernel_altmemddr_0_phy_alt_mem_phy	kernel_altmemddr_0_phy_alt_mem_phy_inst(
	...
	defparam
		kernel_altmemddr_0_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 5999,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "5999 ps",
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1074,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1092,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 56,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		kernel_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		kernel_altmemddr_0_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="kernel_altmemddr_0_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (Micron MT47H64M16)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="kernel_altmemddr_0_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="kernel_altmemddr_0_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+kernel_altmemddr_0_phy_alt_mem_phy_seq_wrapper;+kernel_altmemddr_0_phy_alt_mem_phy_reconfig;+kernel_altmemddr_0_phy_alt_mem_phy_pll;+kernel_altmemddr_0_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\ADMINI~1\AppData\Local\Temp\alt6796_3830232927232837069.dir\0025_iptb_gen/kernel_altmemddr_0_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="kernel_altmemddr_0_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
