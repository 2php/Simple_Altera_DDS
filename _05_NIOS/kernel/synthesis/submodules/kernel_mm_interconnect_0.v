...
module kernel_mm_interconnect_0 (
	...
	wire  [91:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire  [91:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [91:0] router_src_data;                                                             // router:src_data -> nios2_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                            // nios2_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [3:0] router_src_channel;                                                          // router:src_channel -> nios2_data_master_limiter:cmd_sink_channel
	...
	wire  [91:0] nios2_data_master_limiter_cmd_src_data;                                      // nios2_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios2_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> nios2_data_master_limiter:cmd_src_ready
	wire   [3:0] nios2_data_master_limiter_cmd_src_channel;                                   // nios2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [91:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                           // nios2_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [3:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> nios2_data_master_limiter:rsp_sink_channel
	...
	wire  [91:0] nios2_data_master_limiter_rsp_src_data;                                      // nios2_data_master_limiter:rsp_src_data -> nios2_data_master_agent:rp_data
	wire         nios2_data_master_limiter_rsp_src_ready;                                     // nios2_data_master_agent:rp_ready -> nios2_data_master_limiter:rsp_src_ready
	wire   [3:0] nios2_data_master_limiter_rsp_src_channel;                                   // nios2_data_master_limiter:rsp_src_channel -> nios2_data_master_agent:rp_channel
	...
	wire  [91:0] router_001_src_data;                                                         // router_001:src_data -> nios2_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                        // nios2_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [3:0] router_001_src_channel;                                                      // router_001:src_channel -> nios2_instruction_master_limiter:cmd_sink_channel
	...
	wire  [91:0] nios2_instruction_master_limiter_cmd_src_data;                               // nios2_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire   [3:0] nios2_instruction_master_limiter_cmd_src_channel;                            // nios2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [91:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                       // nios2_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [3:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> nios2_instruction_master_limiter:rsp_sink_channel
	...
	wire  [91:0] nios2_instruction_master_limiter_rsp_src_data;                               // nios2_instruction_master_limiter:rsp_src_data -> nios2_instruction_master_agent:rp_data
	...
	wire   [3:0] nios2_instruction_master_limiter_rsp_src_channel;                            // nios2_instruction_master_limiter:rsp_src_channel -> nios2_instruction_master_agent:rp_channel
	...
	wire   [3:0] nios2_data_master_limiter_cmd_valid_data;                                    // nios2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [3:0] nios2_instruction_master_limiter_cmd_valid_data;                             // nios2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
